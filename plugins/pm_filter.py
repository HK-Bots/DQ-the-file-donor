...
async def pm_text(bot, message):
    ...
    await message.reply_text(text="<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ᴏɴ ᴏᴜʀ <a href=https://t.me/moviehubsearchgroup>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ👇\n\nʜᴇʏ ᴅᴜᴅᴇ 😍 ,\n\nJaha App Movies Search nhi kr sakte ho. Group mei jaakr Movies or Webseries Name Type kro <a href=https://t.me/+IWa-0TSkRkxjMDA1>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a></b>",   
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/h_k_Bots")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Mr_HKs")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
