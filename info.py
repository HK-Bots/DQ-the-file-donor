...
#Direct Link Generator By @Mr_HKs
DIRECT_GEN_DB = int(environ.get("DIRECT_GEN_DB", "-1001976017338")) # Enter your channel id
DIRECT_GEN_URL = environ.get("DIRECT_GEN_URL", "https://filetolinkhk-harmish77.koyeb.app/") # https://example.com/
